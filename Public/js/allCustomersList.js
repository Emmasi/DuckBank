...
const listCostomers = (customers) => {
  ...
  customers.forEach((customer) => {
    ...
    li.innerHTML = `
        ...
        <h3>${customer.name}</h3> 
        <a href="/api/customers/" class ="delete" data-custid="${
          customer._id
        }"><i class="fa fa-trash" id="fa-trash"aria-hidden="true"></i></a>
        </div>
        <div class="customerName">
